...
- (void)setNavSearchView
{
    ...
    CGFloat wSearchView = screenWidth - xSearchView - margin_10 - 39;
    ...
    //边框
    [Tools setBorder:searchCtrl andColor:colorGrayHome andWidth:0.5];
    ...
    //提示文本
    CGFloat xP = CGRectGetMaxX(fdjView.frame) + margin_5;
    ...
    placeLab.textColor = colorGrayHome;
